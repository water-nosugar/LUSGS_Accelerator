...
本仓库是在 gem5 v25.1.0.0 基础上实现的 CFD 5×5 block LU-SGS
体系结构研究项目。项目入口、构建方法和实验管理见
[`projects/cfd_dsa/README.md`](projects/cfd_dsa/README.md)，方案标签说明见
[`projects/cfd_dsa/docs/GIT_SCHEME_TAGS.md`](projects/cfd_dsa/docs/GIT_SCHEME_TAGS.md)。
