#!/usr/bin/env python3
"""LU-SGS Step3 runner: descriptor-driven macro controller."""
...
os.environ["GEM5_CFD_RUN_WRAPPER"] = "lusgs-step3"
os.environ["GEM5_CFD_REPORT_FOCUS"] = "patha"

_append_default("--binary", binary("test_cfd_lusgs_patha_step3_arm"))
